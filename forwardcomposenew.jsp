    ...
    <div class="my-modal composenew" id="modalOne">
		...
		<%@page import="java.sql.*" %>
            ...
            <div class="mb-3 recipients">
                <input type="email" name="recepients" class="form-control" placeholder="Email">
            ...
            <div class="mb-3">
                <input type="text" name="subject" class="form-control" placeholder="Subject" value="Fwd: <%= rs.getString("subject") %>">
                <hr class="m-0">
            </div>
            <div class="mb-3">
                <textarea type="text" name="content" class="form-control textarea">---------- Forwarded message ---------&#10;From: &lt;<%= rs.getString("fromone") %>&gt;&#13;Subject: <%= rs.getString("subject") %>&#10;To: &lt;<%= rs.getString("recepients") %>&gt;&#13;&#13;&#13;&#13;<%= rs.getString("content") %>&#13;</textarea>
            </div>
