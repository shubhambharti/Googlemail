    ...
    <div class="my-modal composenew" id="modalOne">
		...
		<%@page import="java.sql.*" %>
            ...
            <div class="mb-3 recipients">
                <input type="email" name="recepients" class="form-control" placeholder="" value="<%= rs.getString("fromone") %>">
            ...
            <div class="mb-3">
                <input type="text" name="subject" class="form-control" placeholder="Subject" value="Re: <%= rs.getString("subject") %>">
                <hr class="m-0">
            </div>
            <div class="mb-3">
                <textarea type="text" name="content" class="form-control textarea">On: <%= rs.getString("senddate") %> <%= rs.getString("fromone") %> wrote:&#10;<%= rs.getString("content") %></textarea>
            </div>
            <footer class="row ms-2">
                ...
                <div class="col-lg-10 col-md-9 col-sm-9 utility">
                    <button title="Formating option"><i class="fa-solid fa-a"></i></button>
