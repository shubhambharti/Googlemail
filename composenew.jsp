...
<body>
    <div class="my-modal composenew" id="modalOne">
        ...
        <form class="mt-3" id="form" action="compose.jsp" method="post">
            <div class="mb-3 recipients">
                <input type="email" name="recepients" class="form-control" placeholder="Recipients">
            ...
            <div class="mb-3">
                <textarea type="text" name="content" class="form-control textarea"></textarea>
            </div>
